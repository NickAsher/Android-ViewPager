...
public class ImagePagerAdapter extends PagerAdapter{
    ...
    public ImagePagerAdapter(Context context, ArrayList<Integer> arr) {
        this.context = context;
        this.listOfImages = arr;
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        View itemView = layoutInflater.inflate(R.layout.layout_imagepager, container, false);
